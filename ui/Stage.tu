...
/**
 * A common superclass for all stages of church. Provides functions to print
 * status or debug messages.
 */
unit class Stage
  inherit Object in "../util/Object.tu"
  export enableDebug
  
  /** Boolean flag to enable or disable debug information for a stage. */
  var debug : boolean := false  

  /**
   * Prints an error message in red.
   *
   * @param stage  Name of the stage where the error happend.
   * @param msg    Error message string.
   */ 
  proc error(stage : string, msg : string)
    colour(red)
    put " ", stage, msg
    colour(black)
  end error
   ...
   */ 
  proc warning(stage : string, msg : string)
    colour(blue)
    put " ", stage, msg
    colour(black)
  end warning
   ...
   */
  proc info(stage : string, msg : string)
    colour(green)
    put " ", stage, msg
    colour(black)
  end info
   ...
   *
   * @param enable  true to enable debug information.
   */
  proc enableDebug(enable : boolean)
    debug := enable
  end enableDebug
